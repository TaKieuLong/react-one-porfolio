    ...
    from-black to-gray-800 p-4 text-white'>
        ...
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/d4e9b8f4-a865-4dc1-bd29-cdd8affab2d9"
                 method='POST'
                 className='flex flex-col w-full md:w-1/2'>
                    ...
                    className='p-2 bg-transparent border-2 my-4
                    rounded-md text-white focus: outline-none' 
                    />
                    <textarea name="message"
                        placeholder='Enter your message' id="" rows="10" className='p-2 bg-transparent border-2 rounded-md 
